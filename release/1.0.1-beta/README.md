# MagicMirror Release 1.0.1-beta
...
```bash
flutter build apk --release --build-name=1.0.1-beta --build-number=2
flutter build appbundle --release --build-name=1.0.1-beta --build-number=2
```
...
```bash
adb install -r release/1.0.1-beta/magicmirror-v1.0.1.apk
```
