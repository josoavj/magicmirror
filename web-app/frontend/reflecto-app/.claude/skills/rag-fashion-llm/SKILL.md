...
## 🎯 Objectifs
0. **Préparer et explorer** les données brutes de scraping dans `public/data/` pour identifier les informations pertinentes sur la morphologie, la colorimétrie, les saisons et les dress codes.
...
- [ ] Les résultats de tests, modèle, pkl, et logs de performance pour chaque provider LLM.
