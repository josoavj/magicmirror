...
export const RecommendationsClient = ({ weather, date }: RecommendationsClientProps) => {
    ...
    <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-beige mb-1 md:mb-2">Reflecto Suggestions</h1>
          <p className="text-slate text-sm md:text-lg">AI-tailored looks based on your <strong>H-Shape</strong> silhouette and <strong>Warm</strong> skin tone.</p>
        </div>
        <div className="flex gap-3">
           <button className="p-3 md:p-4 glass-gold rounded-full text-gold hover:scale-110 transition-transform">
             <Volume2 size={20} />
           </button>
        </div>
      </header>
